# CodeKitBox Promotion Kit

These drafts are starting points for sharing CodeKitBox. Adjust the opening
sentence to match each community and participate in the discussion after
...
- `social-posts.md`: Short social posts in English, Chinese, and Japanese

Recommended order:

1. Publish the GitHub repository.
2. Share one useful tutorial on Qiita or Zenn.
