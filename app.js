const i18n = {
  en: {
    ...
    "aiGuides.eyebrow": "AI practical guides",
    "aiGuides.title": "Use AI outputs more safely",
    "aiGuides.all": "View all guides",
    "aiGuides.writing.kicker": "Writing",
    "aiGuides.writing.title": "Check AI draft length before publishing",
    "aiGuides.writing.copy": "Review word count, character count, titles, and descriptions.",
    "aiGuides.json.kicker": "Data",
    "aiGuides.json.title": "Format JSON from AI output",
    "aiGuides.json.copy": "Validate and clean JSON before using it in apps or automations.",
    "aiGuides.image.kicker": "Images",
    "aiGuides.image.title": "Compress images before upload",
    "aiGuides.image.copy": "Prepare images for AI tools, forms, email, and websites.",
    "aiGuides.qr.kicker": "Sharing",
    "aiGuides.qr.title": "Turn AI links into QR codes",
    "aiGuides.qr.copy": "Create QR codes for final links, event text, and instructions.",
    "footer.about": "About",
  ...
  zh: {
    ...
    "aiGuides.eyebrow": "AI 实用文章",
    "aiGuides.title": "更安全地使用 AI 输出内容",
    "aiGuides.all": "查看全部文章",
    "aiGuides.writing.kicker": "写作",
    "aiGuides.writing.title": "发布前检查 AI 草稿长度",
    "aiGuides.writing.copy": "检查字数、字符数、标题和页面描述。",
    "aiGuides.json.kicker": "数据",
    "aiGuides.json.title": "整理 AI 输出的 JSON",
    "aiGuides.json.copy": "用于应用或自动化前，先验证并清理 JSON。",
    "aiGuides.image.kicker": "图片",
    "aiGuides.image.title": "上传前压缩图片",
    "aiGuides.image.copy": "为 AI 工具、表单、邮件和网站准备图片。",
    "aiGuides.qr.kicker": "分享",
    "aiGuides.qr.title": "把 AI 链接做成二维码",
    "aiGuides.qr.copy": "为最终链接、活动文案和说明生成二维码。",
    "footer.about": "关于",
    "footer.privacy": "隐私",
    "footer.terms": "条款",
  ...
  ja: {
    ...
    "aiGuides.eyebrow": "AI 実用ガイド",
    "aiGuides.title": "AI の出力をより安全に使う",
    "aiGuides.all": "すべてのガイドを見る",
    "aiGuides.writing.kicker": "文章",
    "aiGuides.writing.title": "公開前に AI 下書きの長さを確認",
    "aiGuides.writing.copy": "単語数、文字数、タイトル、説明文を確認します。",
    "aiGuides.json.kicker": "データ",
    "aiGuides.json.title": "AI 出力の JSON を整形",
    "aiGuides.json.copy": "アプリや自動化で使う前に JSON を検証します。",
    "aiGuides.image.kicker": "画像",
    "aiGuides.image.title": "アップロード前に画像を圧縮",
    "aiGuides.image.copy": "AI ツール、フォーム、メール、Web 用に画像を準備します。",
    "aiGuides.qr.kicker": "共有",
    "aiGuides.qr.title": "AI のリンクを QR コードに",
    "aiGuides.qr.copy": "最終リンク、イベント文、案内文を QR コードにします。",
    "footer.about": "概要",
