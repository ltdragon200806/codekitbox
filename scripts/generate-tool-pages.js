...
const tools = [
  ...
  { id: "imagecompressor", slug: "image-compressor", title: "Image Compressor Online", description: "Compress JPG, PNG, or WebP images locally in your browser.", intro: "Reduce image file size without uploading your picture to a server.", what: "Image compression reduces file size by changing quality, format, or dimensions. It is useful before uploading photos to websites, forms, blogs, and social platforms.", example: "Choose an image, select JPEG or WebP output, adjust quality, then download the compressed result.", faq: [["Are my images uploaded?", "No. Images are processed locally in your browser."], ["Which format compresses best?", "WebP often creates smaller files, while JPEG is widely compatible. PNG is best for sharp graphics and transparency."]] },
  { id: "imageresizer", slug: "image-resizer", title: "Image Resizer Online", description: "Resize JPG, PNG, or WebP images by width and height in your browser.", intro: "Change photo dimensions locally while keeping the aspect ratio if needed.", what: "Image resizing changes pixel dimensions. Smaller images load faster and are easier to upload, attach, or share.", example: "Choose an image, enter a new width or height, keep aspect ratio enabled, then download the resized file.", faq: [["Will resizing reduce quality?", "Reducing dimensions usually lowers detail, but it also makes files smaller and faster to upload."], ["Can I keep the original ratio?", "Yes. Keep aspect ratio enabled and enter either width or height."]] },
  { id: "imageconverter", slug: "image-converter", title: "Image Format Converter", description: "Convert images between JPG, PNG, and WebP locally in your browser.", intro: "Convert common image formats without uploading your file.", what: "Image format conversion changes how picture data is stored. JPEG is common for photos, PNG supports transparency, and WebP can provide compact web-friendly files.", example: "Choose an image, pick the output format, adjust quality when available, then download the converted image.", faq: [["Does converting preserve transparency?", "PNG and WebP can preserve transparency, but converting transparent images to JPEG fills the background with white."], ["Is WebP supported everywhere?", "Modern browsers support WebP, but some older tools may still prefer JPEG or PNG."]] },
  ...
  { id: "wordcount", slug: "word-character-counter", title: "Word and Character Counter", description: "Count words, characters, characters without spaces, and sentences.", intro: "Measure text length instantly while you type.", what: "Word and character counts are useful for essays, social posts, forms, and writing limits.", example: "Type or paste text to see the counts update instantly.", faq: [["Is my text uploaded?", "No. Counting happens locally in your browser."], ["Are spaces counted?", "The tool shows both total characters and characters without spaces."]] },
];
